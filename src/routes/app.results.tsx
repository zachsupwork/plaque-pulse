...
import { intentBreakdown, sourceSplit } from "@/lib/metrics";
import { INTENT_LABEL } from "@/lib/taplocal";
...
function ResultsPage() {
  ...
  return (
    <div className="space-y-5">
      ...
      <GlassPanel sheen className="border-accent/30 p-4">
        <p className="text-[12px] font-semibold tracking-wide text-accent uppercase">We can prove this</p>
      ...
      <GlassPanel className="p-4">
        <p className="font-display text-[14px] font-semibold tracking-tight">What people were asked to do</p>
        <div className="mt-3 space-y-2.5">
          {intents.map((i) => (
            <div key={i.intent}>
      ...
      <GlassPanel className="p-4">
        <p className="font-display text-[14px] font-semibold tracking-tight">How people reached you</p>
